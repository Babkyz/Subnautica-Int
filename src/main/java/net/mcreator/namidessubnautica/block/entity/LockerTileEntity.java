package net.mcreator.namidessubnautica.block.entity;
...
public class LockerTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public LockerTileEntity(BlockPos pos, BlockState state) {
		super(NamidesSubnauticaModBlockEntities.LOCKER.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<LockerTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<LockerTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new WalllockMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
