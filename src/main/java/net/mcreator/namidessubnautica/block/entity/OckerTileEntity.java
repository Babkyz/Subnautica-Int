...
public class OckerTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public OckerTileEntity(BlockPos pos, BlockState state) {
		super(NamidesSubnauticaModBlockEntities.OCKER.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<OckerTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<OckerTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
