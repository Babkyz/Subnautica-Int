 ...
 *
 */
package net.mcreator.namidessubnautica;
...
@Mod("namides_subnautica")
public class NamidesSubnauticaMod {
	public static final Logger LOGGER = LogManager.getLogger(NamidesSubnauticaMod.class);
	public static final String MODID = "namides_subnautica";
	...
	public NamidesSubnauticaMod() {
		...
		NamidesSubnauticaModTabs.REGISTRY.register(bus);

		NamidesSubnauticaModMenus.REGISTRY.register(bus);
	}
