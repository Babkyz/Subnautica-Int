...
public class NamidesSubnauticaModItems {
	...
	public static final RegistryObject<Item> LOCKER = REGISTRY.register(NamidesSubnauticaModBlocks.LOCKER.getId().getPath(), () -> new LockerDisplayItem(NamidesSubnauticaModBlocks.LOCKER.get(), new Item.Properties()));
