...
public class NamidesSubnauticaModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<LockerTileEntity>> LOCKER = REGISTRY.register("locker", () -> BlockEntityType.Builder.of(LockerTileEntity::new, NamidesSubnauticaModBlocks.LOCKER.get()).build(null));
